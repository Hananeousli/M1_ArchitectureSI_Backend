...
public class ParcoursUnitTests
{
    ...
    public async Task CreateParcoursUseCase()
    {
        ...
        mockParcours
            ...
            .ReturnsAsync(new List<Parcours>());  // Liste vide au lieu de null
    ...
    public async Task AddEtudiantDansParcoursUseCase()
    {
        long idEtudiant = 1;
        long idParcours = 3;
        Etudiant etudiant= new Etudiant { Id = 1, NumEtud = "1", Nom = "nom1", Prenom = "prenom1", Email = "test@test.com" };
        ...
        // Configuration pour gérer les 2 appels à FindByConditionAsync
        mockEtudiant
            .SetupSequence(repo=>repo.FindByConditionAsync(It.IsAny<Expression<Func<Etudiant, bool>>>()))
            .ReturnsAsync(etudiants)  // 1er appel : l'étudiant existe
            .ReturnsAsync(new List<Etudiant>());  // 2e appel : pas encore inscrit
